    ...
    return (
        <div >
            ...
            <div
                ...
                {log && (
                    <div className="flex   items-center sm:items-stretch gap-2 sm:gap-2 w-full md:w-[40%]">
                        <input
                            type="text"
                            value={search}
                            ...
                            className="w-full sm:flex-1 border border-gray-400 rounded-md p-2 outline-none text-sm sm:text-base"
                        />
                        <button
                            onClick={handlesearchbtn}
                            disabled={!search.trim()}
                            className={`bg-gradient-to-r from-green-300 to-green-500 hover:from-green-500 hover:to-green-300 p-2 rounded-md text-sm sm:text-base transition-all duration-300 ${!search.trim() ? "opacity-50 cursor-not-allowed" : ""
                                }`}
                        >
                            Search
                        </button>
                ...
                <div>
                    {log ? (
                        <button
                            onClick={logout}
                            className=" hidden md:block text-sm ml-24 md:ml-28
