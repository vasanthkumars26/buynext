    ...
    return (
        <div >
            ...
            <div
                ...
                <div className="hidden gap-16 items-center  lg:flex">
                    ...
                    <div className='bg-green-200 p-2 rounded-xl shadow-md' >
                        <Link to="/orders" className='flex items-center' >Your Orders!<span className='flex items-center text-red-600 font-extrabold  rounded-full' >({orders.length})</span> </Link>
                    </div>
      ...
      transition-all duration-500 ease-in-out"
        ...
        <ul className="p-4 space-y-6 text-lg">
          ...
          <li><Link to="/wishlist" onClick={() => setMenuOpen(false)}>Wishlist ({wishlist.length})</Link></li>
          ...
          <li><Link to="/orders" onClick={() => setMenuOpen(false)}>Orders ({orders.length})</Link></li>
          <li>
            {log ? (
