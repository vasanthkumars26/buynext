...
const OrdersPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto sm:mt-[10%] md:mt-[9%] lg:mt-[10%] ">
      <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-green-700 to-black bg-clip-text text-transparent">Your Orders</h1>
          ...
          <div key={order.id} className="border border-gray-500 p-4 rounded-lg shadow-md">
            ...
            <div className="space-y-2">
              {order.items.map((item) => (
                ...
                >
                  <span>
                    {item.desc} <span className="text-red-500" >(x{item.qty})</span>
                  </span>
