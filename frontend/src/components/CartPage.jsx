...
const CartPage = () => {
  ...
  const { cart, updateqty, removeFromCart, loading, error } = useCart();
  ...
  if (loading) {
    return <h2 className="text-center mt-[28%] md:mt-[10%] text-xl animate-pulse">Loading your cart...</h2>;
  }

  if (error) {
    return <h2 className="text-center mt-[28%] md:mt-[10%] text-xl text-red-500">{error}</h2>;
  }
