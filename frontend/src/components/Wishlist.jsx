          ...
          >
            <div className="flex items-start sm:items-center gap-4 w-full sm:w-auto">
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* optional small meta line (keeps layout flexible) */}
            ...
            <div className="flex items-center gap-3 mt-3 sm:mt-0">
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-2 rounded-2xl text-sm font-medium bg-gradient-to-r from-cyan-400 to-indigo-500 text-gray-900 shadow hover:scale-105 transition-transform"
              >
                <FaShoppingCart /> Add
              </button>
